...
\item We propose a basic method for fuzzing using program mutants.
  ...
  \item We demonstrate, by a FuzzBench-based evaluation, that our
    ...
    original program.  In fact, one variation of our approach (using
    heuristically selected mutants) scores best by
    \emph{both} of the primary FuzzBench evaluation methods, for a large set
